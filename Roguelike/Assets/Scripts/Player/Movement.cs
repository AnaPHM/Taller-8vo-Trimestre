...
public class Movement : MonoBehaviour, IDamageable, IExperience
{
    ...
    private IEnumerator ActivateHitbox()
    {
        ...
        if (attackParticlePrefab != null && hitboxCenter != null)
        {
            ...
            particles.Play();
            Destroy(particles.gameObject, particles.main.duration); // Destruir despu�s de la duraci�n del efecto
        }
        //
    ...
    void Update()
    {
        ...
        // Actualizar rotaci�n del personaje
        if (movementInput != Vector2.zero)
        {
    ...
    void UpdateAnimator()
 {
     ...
     //A{adir estas tres líneas para sincrónizar Animator:
